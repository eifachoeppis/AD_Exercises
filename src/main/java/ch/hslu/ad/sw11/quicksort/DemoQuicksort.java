...
import ch.hslu.ad.sw11.array.sum.SumTask;
...
public final class DemoQuicksort {
    ...
    public static void main(final String[] args) {
        ...
        LOG.info("QuicksortTask  : " + (end - start) / 1_000_000 + " ms.");
        LOG.info("iSorted: " + isSorted(array));
        ...
        LOG.info("QuicksortRec.  : " + (end - start) / 1_000_000 + " ms.");
        sumTask = new SumTask(array);
        result = pool.invoke(sumTask);
        ...
        LOG.info("Arrays.sort    : " + (end - start) / 1_000_000 + " ms.");
        sumTask = new SumTask(array);
        result = pool.invoke(sumTask);
        ...
        LOG.info("Arrays.parallelSort    : " + (end - start) / 1_000_000 + " ms.");
        sumTask = new SumTask(array);
        result = pool.invoke(sumTask);
        LOG.info("Sort checksum  : " + result);
    }
